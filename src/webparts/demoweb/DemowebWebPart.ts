...
import Demoweb from './components/Demoweb';
import { IDemowebProps } from './components/IDemowebProps';
...
export default class DemowebWebPart extends BaseClientSideWebPart<IDemowebWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IDemowebProps> = React.createElement(
      Demoweb,
      {
